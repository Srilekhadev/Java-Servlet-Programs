			...
			<ul class="sidemenu">
				...
				<li><a href="Last.jsp"><font face="Tohama" color="#FFFFFF">SQL Last</font></a></li>
                  ...
                  border=0>
                    <TBODY>
                    <TR>
                      <TD>SELECT column_name(s)<BR>FROM table_name1<BR>LEFT 
                        JOIN table_name2<BR>ON 
                        table_name1.column_name=table_name2.column_name</TD></TR></TBODY></TABLE>
                  <P><B>PS:</B> In some databases LEFT JOIN is called LEFT OUTER 
                  JOIN.</P>
                  <HR>
                  ...
                  <P>Now we want to list all the persons and their orders - if 
                  any, from the tables above.</P>
                  ...
                  border=0>
                    ...
                    <TR>
                      <TD>SELECT Persons.LastName, Persons.FirstName, 
                        Orders.OrderNo<BR>FROM Persons<BR>LEFT JOIN Orders<BR>ON 
                  ...
                  <P>The LEFT JOIN keyword returns all the rows from the left 
                  table (Persons), even if there are no matches in the right 
                  table (Orders).</P>
