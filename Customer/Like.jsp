	  ...
	  <div id="sidebar">							
			...
			<ul class="sidemenu">
				...
				<li><a href="Last.jsp"><font face="Tohama" color="#FFFFFF">SQL Last</font></a></li>
                  ...
                  <H2><P class=intro>The LIKE operator is used in a WHERE clause to 
                  search for a specified pattern in a column.</P></H2>
                  <HR>

                  <H2>The LIKE Operator</H2>
                  <P>The LIKE operator is used to search for a specified pattern 
                  in a column.</P>
                  ...
                  border=0>
                    ...
                    <TR>
                      <TD>SELECT column_name(s)<BR>FROM table_name<BR>WHERE 
                        column_name LIKE pattern</TD></TR></TBODY></TABLE><BR>
                  <HR>
                  ...
                  starts with "s" from the table above.</P>
                  ...
                  border=0>
                    ...
                    's%'</TD></TR></TBODY></TABLE>
                  <P>The "%" sign can be used to define wildcards (missing 
                  ...
                  ends with an "s" from the "Persons" table.</P>
                  <P>We use the following SELECT statement:</P>
                  <TABLE class=code cellSpacing=0 cellPadding=0 width="100%" 
                  border=0>
                    <TBODY>
                  ...
                  <P>Next, we want to select the persons living in a city that 
                  contains the pattern "tav" from the "Persons" table.</P>
                  <P>We use the following SELECT statement:</P>
                  <TABLE class=code cellSpacing=0 cellPadding=0 width="100%" 
                  border=0>
                    <TBODY>
                  ...
                  width="100%" border=1>
                    ...
                    <TR>
                      ...
                      <TD>Storgt 20</TD>
                      <TD>Stavanger</TD></TR></TBODY></TABLE>
                  <P>It is also possible to select the persons living in a city 
                  that NOT contains the pattern "tav" from the "Persons" table, 
                  by using the NOT keyword.</P>
                  <P>We use the following SELECT statement:</P>
                  <TABLE class=code cellSpacing=0 cellPadding=0 width="100%" 
                  border=0>
                    <TBODY>
                    <TR>
                      <TD>SELECT * FROM Persons<BR>WHERE City NOT LIKE 
                      '%tav%'</TD></TR></TBODY></TABLE>
                  <P>The result-set will look like this:</P>
                  <TABLE class=reference cellSpacing=0 cellPadding=0 
                  width="100%" border=1>
