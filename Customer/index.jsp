...
<li><a href="index.jsp"><font face="Tohama" color="#FFFFFF">SQL home</font></a></li>
				...
				<li><a href="Last.jsp"><font face="Tohama" color="#FFFFFF">SQL Last</font></a></li>
										  ...
										  <tr><td height="30px"></td></tr>
                                            <TR>
                                              <TD class=middle-table-padding vAlign=top align=left><TABLE  align="center" cellSpacing=0 cellPadding=0 width="100%" border=1 bgcolor="#FFFFFF" >
                                                  <TBODY>
                                                    <TR>
                                                      <TD class=padding-lr vAlign=top ><!--#include virtual="left.shtml" -->
                                                        
														<TABLE cellSpacing=0 cellPadding=0 width="98%" border="0" bordercolor="#CCCCCC" align="center">
                                                            <!--main table row-->
                                                            <TBODY>
                                                              <TR align="justify">
                                                                <TD vAlign=top width=110><IMG alt=SQL 
                        src="images/focusing_im.jpg" border=0></TD>
                                                                <TD vAlign=top><p>&nbsp;</p><P class=tutintro>SQL is a standard language for 
                                                                  accessing and manipulating databases.</P>
                                                                    <P class=tutintro>Our SQL tutorial will teach you how to 
                                                                      use SQL to access and manipulate data in MySQL, SQL 
                                                                      Server, MS Access, Oracle, Sybase, DB2, and other 
                                                                      database systems.</P>
                                                                  </P></TD>
                                                                <TD>&nbsp;</TD>
                                                      </TR>
											  ...
											  <table><tr><td width="778"><H2>What is SQL?</H2>
											  <UL>
												<LI>SQL stands for Structured Query Language 
												<LI>SQL lets you access and manipulate databases 
												<LI>SQL is an ANSI (American National Standards Institute) 
												standard </LI></UL><HR>
                  ...
                  <UL>
                    ...
                    <LI>SQL can insert records in a database 
                    <LI>SQL can update records in a database 
                    <LI>SQL can delete records from a database 
                    <LI>SQL can create new databases 
                    <LI>SQL can create new tables in a database 
                    <LI>SQL can create stored procedures in a database 
                    <LI>SQL can create views in a database 
                    <LI>SQL can set permissions on tables, procedures, and views 
                    </LI></UL>
                  <HR>
											    
											    <H2 class=tutheader>SQL Quick Reference</H2>
												  <P>An SQL Quick Reference. Print it and put it in your 
												  pocket.</P>
												  
												  <p><a href="pocket.jsp"><span class="small_bold_orange_text">SQL Quick Reference </span></a></p>
												  
												  <H2 class=tutheader>SQL Data Types</H2>
												  <P>Data types and ranges for Microsoft Access, MySQL and SQL 
												  Server.</P>
												  <P><A href="Databyte.jsp"><span class="small_bold_orange_text">SQL Data Types</span></A></P>
