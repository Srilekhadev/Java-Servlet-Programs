	  ...
	  <div id="sidebar">							
			...
			<ul class="sidemenu">
				...
				<li><a href="Last.jsp"><font face="Tohama" color="#FFFFFF">SQL Last</font></a></li>
                  ...
                  <h2><P class=intro>This chapter will explain the SELECT DISTINCT 
                  statement.</P></h2>
                  <hr>
                  <H2>The SQL SELECT DISTINCT Statement</H2>
                  <P>In a table, some of the columns may contain duplicate 
                  values. This is not a problem, however, sometimes you will 
                  want to list only the different (distinct) values in a 
                  table.</P>
                  <P>The DISTINCT keyword can be used to return only distinct 
                  (different) values.</P>
                  ...
                  border=0>
                    <TBODY>
                    <TR>
                      <TD>SELECT DISTINCT column_name(s)<BR>FROM 
                  ...
                  <P>Now we want to select only the distinct values from the 
                  column named "City" from the table above.</P>
                  <P>We use the following SELECT statement:</P>
                  <TABLE class=code cellSpacing=0 cellPadding=0 width="100%" 
                  border=0>
                    <TBODY>
                    <TR>
                      <TD>SELECT DISTINCT City FROM 
