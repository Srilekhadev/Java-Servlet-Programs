	  ...
	  <div id="sidebar">							
			...
			<ul class="sidemenu">
				...
				<li><a href="Last.jsp"><font face="Tohama" color="#FFFFFF">SQL Last</font></a></li>
                  ...
                  <P>The AVG() function returns the average value of a numeric 
                  column.</P>
                  ...
                  border=0>
                    <TBODY>
                    <TR>
                      <TD>SELECT AVG(column_name) FROM 
                  ...
                  <P>Now we want to find the average value of the "OrderPrice" 
                  fields.</P>
                  ...
                  border=0>
                    <TBODY>
                    <TR>
                      <TD>SELECT AVG(OrderPrice) AS OrderAverage FROM 
                  ...
                  border=1>
                    <TBODY>
                    <TR>
                      <TH align=left>OrderAverage</TH></TR>
                    <TR>
                      <TD>950</TD></TR></TBODY></TABLE>
                  <P>Now we want to find the customers that have an OrderPrice 
                  value higher than the average OrderPrice value.</P>
                  <P>We use the following SQL statement:</P>
                  <TABLE class=code cellSpacing=0 cellPadding=0 width="100%" 
                  border=0>
                    <TBODY>
                    <TR>
                      <TD>SELECT Customer FROM Orders<BR>WHERE 
                        OrderPrice&gt;(SELECT AVG(OrderPrice) FROM 
                    Orders)</TD></TR></TBODY></TABLE>
                  <P>The result-set will look like this:</P>
                  <TABLE class=reference cellSpacing=0 cellPadding=0 width="50%" 
                  border=1>
                    ...
                    <TR>
                      <TD>Nilsen</TD></TR>
                    <TR>
                      <TD>Jensen</TD></TR></TBODY></TABLE><BR>
