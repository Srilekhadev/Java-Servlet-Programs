    ...
    <td align="center" valign="top"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
	  ...
	  <div id="sidebar">							
			...
			<ul class="sidemenu">
               ...
               <h2>   <P class=intro>With SQL, an alias name can be given to a table 
                  or to a column.</P></h2>
                  <HR>

                  <H2>SQL Alias</H2>
                  <P>You can give a table or a column another name by using an 
                  alias. This can be a good thing to do if you have very long or 
                  complex table names or column names.</P>
                  <P>An alias name could be anything, but usually it is 
                  short.</P>
                  ...
                  border=0>
                    <TBODY>
                    <TR>
                      <TD>SELECT column_name(s)<BR>FROM table_name<BR>AS 
                        alias_name</TD></TR></TBODY></TABLE>
                  <H3>SQL Alias Syntax for Columns</H3>
                  <TABLE class=code cellSpacing=0 cellPadding=0 width="100%" 
                  border=0>
                    <TBODY>
                    <TR>
                      <TD>SELECT column_name AS alias_name<BR>FROM 
                      table_name</TD></TR></TBODY></TABLE><BR>
                  <HR>

                  <H2>Alias Example</H2>
                  <P>Assume we have a table called "Persons" and another table 
                  called "Product_Orders". We will give the table aliases of "p" 
                  an "po" respectively.</P>
                  <P>Now we want to list all the orders that "Ola Hansen" is 
                  responsible for.</P>
                  ...
                  border=0>
                    <TBODY>
                    <TR>
                      <TD>SELECT po.OrderID, p.LastName, p.FirstName<BR>FROM 
                        Persons AS p,<BR>Product_Orders AS po<BR>WHERE 
                        p.LastName='Hansen'<BR>WHERE 
                    p.FirstName='Ola'</TD></TR></TBODY></TABLE>
                  <P>The same SELECT statement without aliases:</P>
                  <TABLE class=code cellSpacing=0 cellPadding=0 width="100%" 
                  border=0>
                    <TBODY>
                    <TR>
                      <TD>SELECT Product_Orders.OrderID, Persons.LastName, 
                        Persons.FirstName<BR>FROM 
                        Persons,<BR>Product_Orders<BR>WHERE 
                        Persons.LastName='Hansen'<BR>WHERE 
                        Persons.FirstName='Ola'</TD></TR></TBODY></TABLE>
                  <P>As you'll see from the two SELECT statements above; aliases 
                  can make queries easier to both write and to read.</P>
