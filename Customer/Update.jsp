	  ...
	  <div id="sidebar">							
			...
			<ul class="sidemenu">
				...
				<li><a href="Last.jsp"><font face="Tohama" color="#FFFFFF">SQL Last</font></a></li>
                  ...
                  <h2><P class=intro>The UPDATE statement is used to update records 
                  in a table.</P></h2>
                  <HR>

                  <H2>The UPDATE Statement</H2>
                  <P>The UPDATE statement is used to update existing records in 
                  a table.</P>
                  ...
                  border=0>
                    <TBODY>
                    <TR>
                      <TD>UPDATE table_name<BR>SET column1=value, 
                        column2=value2,...<BR>WHERE 
                    some_column=some_value</TD></TR></TBODY></TABLE>
                  <P><B>Note:</B> Notice the WHERE clause in the UPDATE syntax. 
                  ...
                  <P>Now we want to update the person "Tjessem, Jakob" in the 
                  "Persons" table.</P>
                  ...
                  border=0>
                    <TBODY>
                    <TR>
                      <TD>UPDATE Persons<BR>SET Address='Nissestien 67', 
                        City='Sandnes'<BR>WHERE LastName='Tjessem' AND 
                        FirstName='Jakob'</TD></TR></TBODY></TABLE>
                  ...
                  <P>Be careful when updating records. If we had omitted the 
                  WHERE clause in the example above, like this:</P>
                  <TABLE class=code cellSpacing=0 cellPadding=0 width="100%" 
                  border=0>
                    <TBODY>
                    <TR>
