	  ...
	  <div id="sidebar">							
			...
			<ul class="sidemenu">
				...
				<li><a href="Last.jsp"><font face="Tohama" color="#FFFFFF">SQL Last</font></a></li>
                 ...
                 <h2> <P class=intro>The ORDER BY keyword is used to sort the 
                  result-set.</P></h2>
                  <HR>

                  <H2>The ORDER BY Keyword</H2>
                  <P>The ORDER BY keyword is used to sort the result-set by a 
                  specified column.</P>
                  <P>The ORDER BY keyword sort the records in ascending order by 
                  default.</P>
                  <P>If you want to sort the records in a descending order, you 
                  can use the DESC keyword.</P>
                  <H3>SQL ORDER BY Syntax</H3>
                  <TABLE class=code cellSpacing=0 cellPadding=0 width="100%" 
                  border=0>
                    <TBODY>
                    <TR>
                      <TD>SELECT column_name(s)<BR>FROM table_name<BR>ORDER BY 
                        column_name(s) ASC|DESC</TD></TR></TBODY></TABLE><BR>
                  <HR>
                  ...
                  <P>Now we want to select all the persons from the table above, 
                  however, we want to sort the persons by their last name.</P>
                  <P>We use the following SELECT statement:</P>
                  <TABLE class=code cellSpacing=0 cellPadding=0 width="100%" 
                  border=0>
                    <TBODY>
                    <TR>
                      <TD>SELECT * FROM Persons<BR>ORDER BY 
                    LastName</TD></TR></TBODY></TABLE>
                  ...
                  <P>Now we want to select all the persons from the table above, 
                  however, we want to sort the persons descending by their last 
                  name.</P>
                  <P>We use the following SELECT statement:</P>
