	  ...
	  <div id="sidebar">							
			...
			<ul class="sidemenu">
				...
				<li><a href="Last.jsp"><font face="Tohama" color="#FFFFFF">SQL Last</font></a></li>
                  ...
                  <h2><P class=intro>The INSERT INTO statement is used to insert new 
                  records in a table.</P></h2>
                  <HR>

                  <H2>The INSERT INTO Statement</H2>
                  <P>The INSERT INTO statement is used to insert a new row in a 
                  table.</P>
                  <H3>SQL INSERT INTO Syntax</H3>
                  <P>It is possible to write the INSERT INTO statement in two 
                  forms. </P>
                  <P>The first form doesn't specify the column names where the 
                  data will be inserted, only their values:</P>
                  <TABLE class=code cellSpacing=0 cellPadding=0 width="100%" 
                  border=0>
                    <TBODY>
                    <TR>
                      <TD>INSERT INTO table_name<BR>VALUES (value1, value2, 
                        value3,...)</TD></TR></TBODY></TABLE>
                  <P>The second form specifies both the column names and the 
                  values to be inserted:</P>
                  <TABLE class=code cellSpacing=0 cellPadding=0 width="100%" 
                  border=0>
                    <TBODY>
                    <TR>
                      <TD>INSERT INTO table_name (column1, column2, 
                        column3,...)<BR>VALUES (value1, value2, 
                    value3,...)</TD></TR></TBODY></TABLE><BR>
                  <HR>
                  ...
                  border=0>
                    <TBODY>
                    <TR>
                      <TD>INSERT INTO Persons<BR>VALUES (4,'Nilsen', 'Johan', 
                        'Bakken 2', 'Stavanger')</TD></TR></TBODY></TABLE>
                  ...
                  <P>It is also possible to only add data in specific 
                  columns.</P>
                  <P>The following SQL statement will add a new row, but only 
                  add data in the "P_Id", "LastName" and the "FirstName" 
                  columns:</P>
                  <TABLE class=code cellSpacing=0 cellPadding=0 width="100%" 
                  border=0>
                    <TBODY>
                    <TR>
                      <TD>INSERT INTO Persons (P_Id, LastName, 
                        FirstName)<BR>VALUES (5, 'Tjessem', 
                    'Jakob')</TD></TR></TBODY></TABLE>
                  <P>The "Persons" table will now look like this:</P>
                  <TABLE class=reference cellSpacing=0 cellPadding=0 
                  width="100%" border=1>
                    <TBODY>
