			...
			<ul class="sidemenu">
				...
				<li><a href="Last.jsp"><font face="Tohama" color="#FFFFFF">SQL Last</font></a></li>
										  ...
										  <tr><td height="30px"></td></tr>
                                            <TR>
                                              <TD class=middle-table-padding vAlign=top align=left><TABLE  align="center" cellSpacing=0 cellPadding=0 width="100%" border=1 bgcolor="#FFFFFF" >
                                                  <TBODY>
                                                    <TR>
                                                      <TD height="109" vAlign=top class=padding-lr >   <p>&nbsp;</p>

                  <h2><P class=intro>The SQL UNION operator combines two or more 
                  SELECT statements.</P></h2>
                  <HR>

                  <H2>The SQL UNION Operator</H2>
                  <P>The UNION operator is used to combine the result-set of two 
                  or more SELECT statements.</P>
                  <P>Notice that each SELECT statement within the UNION must 
                  have the same number of columns. The columns must also have 
                  similar data types. Also, the columns in each SELECT statement 
                  must be in the same order.</P>
                  <H3>SQL UNION Syntax</H3>
                  <TABLE class=code cellSpacing=0 cellPadding=0 width="100%" 
                  border=0>
                    <TBODY>
                    <TR>
                      <TD>SELECT column_name(s) FROM 
                        table_name1<BR>UNION<BR>SELECT column_name(s) FROM 
                        table_name2</TD></TR></TBODY></TABLE>
                  <P><B>Note:</B> The UNION operator selects only distinct 
                  values by default. To allow duplicate values, use UNION 
                  ALL.</P>
                  ...
                  border=0>
                    <TBODY>
                    <TR>
                      <TD>SELECT column_name(s) FROM table_name1<BR>UNION 
                        ALL<BR>SELECT column_name(s) FROM 
                    table_name2</TD></TR></TBODY></TABLE>
                  <P><B>PS:</B> The column names in the result-set of a UNION 
                  are always equal to the column names in the first SELECT 
                  statement in the UNION.</P>
                  <HR>

                  <H2>SQL UNION Example</H2>
                  <P>Look at the following tables:</P>
                  <P><B>"Employees_Norway"</B>:</P>
                  <TABLE class=reference cellSpacing=0 cellPadding=0 width="60%" 
                  border=1>
                    <TBODY>
                    <TR>
                      <TH align=left width="25%">E_ID</TH>
                      <TH align=left width="35%">E_Name</TH></TR>
                    <TR>
                      <TD>01</TD>
                      <TD>Hansen, Ola</TD></TR>
                    <TR>
                      <TD>02</TD>
                      <TD>Svendson, Tove</TD></TR>
                    <TR>
                      <TD>03</TD>
                      <TD>Svendson, Stephen</TD></TR>
                    <TR>
                      <TD>04</TD>
                      <TD>Pettersen, Kari</TD></TR></TBODY></TABLE>
                  ...
                  border=1>
                    ...
                    <TR>
                      <TD>04</TD>
                      <TD>Scott, Stephen</TD></TR></TBODY></TABLE>
                  <P>Now we want to list <B>all the different</B> employees in 
                  Norway and USA.</P>
                  ...
                  border=0>
                    <TBODY>
                    <TR>
                      <TD>SELECT E_Name FROM 
                        Employees_Norway<BR>UNION<BR>SELECT E_Name FROM 
                        Employees_USA</TD></TR></TBODY></TABLE>
                  <P>The result-set will look like this:</P>
                  <TABLE class=reference cellSpacing=0 cellPadding=0 width="60%" 
                  border=1>
                    <TBODY>
                    <TR>
                      <TH align=left width="35%"><B>E_Name</B></TH></TR>
                    <TR>
                      <TD>Hansen, Ola</TD></TR>
                    <TR>
                      <TD>Svendson, Tove</TD></TR>
                    ...
                    <TR>
                      <TD>Scott, Stephen</TD></TR></TBODY></TABLE>
                  <P><B>Note:</B> This command cannot be used to list all 
                  employees in Norway and USA. In the example above we have two 
                  employees with equal names, and only one of them will be 
                  listed. The UNION command selects only distinct values.</P>
                  <HR>

                  <H2>SQL UNION ALL Example</H2>
                  <P>Now we want to list <B>all</B> employees in Norway and 
                  USA:</P>
                  <TABLE class=code cellSpacing=0 cellPadding=0 width="100%" 
                  border=0>
                    <TBODY>
                    <TR>
                      <TD>SELECT E_Name FROM Employees_Norway<BR>UNION 
                        ALL<BR>SELECT E_Name FROM 
                  Employees_USA</TD></TR></TBODY></TABLE>
                  <P><B>Result</B></P>
                  <TABLE class=reference cellSpacing=0 cellPadding=0 width="60%" 
                  border=1>
                    ...
                    <TR>
                      <TD>Svendson, Stephen</TD></TR>
                    <TR>
                      <TD>Scott, Stephen</TD></TR></TBODY></TABLE><BR>
