	  ...
	  <div id="sidebar">							
			...
			<ul class="sidemenu">
				...
				<li><a href="Last.jsp"><font face="Tohama" color="#FFFFFF">SQL Last</font></a></li>
                  ...
                  <P>The INNER JOIN keyword return rows when there is at least 
                  one match in both tables.</P>
                  <H3>SQL INNER JOIN Syntax</H3>
                  <TABLE class=code cellSpacing=0 cellPadding=0 width="100%" 
                  border=0>
                    <TBODY>
                    <TR>
                      <TD>SELECT column_name(s)<BR>FROM table_name1<BR>INNER 
                  ...
                  border=0>
                    ...
                    <TR>
                      <TD>SELECT Persons.LastName, Persons.FirstName, 
                        Orders.OrderNo<BR>FROM Persons<BR>INNER JOIN 
                  ...
                  width="100%" border=1>
                    ...
                    <TR>
                      <TD>Pettersen</TD>
                      <TD>Kari</TD>
                      <TD>44678</TD></TR></TBODY></TABLE>
                  <P>The INNER JOIN keyword return rows when there is at least 
                  one match in both tables. If there are rows in "Persons" that 
