                                  ...
                                  <td align="center" valign="top"><table width="98%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                      <td height="80"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                          <td><span class="black-heading-txt"><font color="#DB3C02">Computer Language Learning and Training</font></span></td>
                                        </tr>
                                        <tr>
	  ...
	  <div id="sidebar">							
			...
			<ul class="sidemenu">
				...
				<li><a href="Last.jsp"><font face="Tohama" color="#FFFFFF">SQL Last</font></a></li>
                  ...
                  <h2><P class=intro>SQL joins are used to query data from two or 
                  more tables, based on a relationship between certain columns 
                  in these tables.</P></h2>
                  <HR>

                  <H2>SQL JOIN</H2>
                  <P>The JOIN keyword is used in an SQL statement to query data 
                  from two or more tables, based on a relationship between 
                  certain columns in these tables.</P>
                  <P>Tables in a database are often related to each other with 
                  keys.</P>
                  <P>A primary key is a column (or a combination of columns) 
                  with a unique value for each row. Each primary key value must 
                  be unique within the table. The purpose is to bind data 
                  together, across tables, without repeating all of the data in 
                  every table.</P>
                  ...
                  width="100%" border=1>
                    ...
                    <TR>
                      ...
                      <TD>Kari</TD>
                      <TD>Storgt 20</TD>
                      <TD>Stavanger</TD></TR></TBODY></TABLE>
                  <P>Note that the "P_Id" column is the primary key in the 
                  "Persons" table. This means that <B>no</B> two rows can have 
                  the same P_Id. The P_Id distinguishes two persons even if they 
                  have the same name.</P>
                  <P>Next, we have the "Orders" table:</P>
                  <TABLE class=reference cellSpacing=0 cellPadding=0 width="50%" 
                  border=1>
                    <TBODY>
                    <TR>
                      <TH align=left width="15%">O_Id</TH>
                      <TH align=left width="20%">OrderNo</TH>
                      <TH align=left width="15%">P_Id</TH></TR>
                    <TR>
                      <TD>1</TD>
                      <TD>77895</TD>
                      <TD>3</TD></TR>
                  ...
                  <P>Note that the "O_Id" column is the primary key in the 
                  "Orders" table and that the "P_Id" column refers to the 
                  persons in the "Persons" table without using their names.</P>
                  <P>Notice that the relationship between the two tables above 
                  is the "P_Id" column.</P>
                  <HR>

                  <H2>Different SQL JOINs</H2>
                  <P>Before we continue with examples, we will list the types of 
                  JOIN you can use, and the differences between them.</P>
                  <UL>
                    <LI><B>JOIN</B>: Return rows when there is at least one 
                    match in both tables 
                    <LI><B>LEFT JOIN</B>: Return all rows from the left table, 
                    even if there are no matches in the right table 
                    <LI><B>RIGHT JOIN</B>: Return all rows from the right table, 
                    even if there are no matches in the left table 
                    <LI><B>FULL JOIN</B>: Return rows when there is a match in 
                    one of the tables </LI></UL>
