	  ...
	  <div id="sidebar">							
			...
			<ul class="sidemenu">
				...
				<li><a href="Last.jsp"><font face="Tohama" color="#FFFFFF">SQL Last</font></a></li>
                  ...
                  <P>The CREATE DATABASE statement is used to create a 
                  database.</P>
                  ...
                  border=0>
                    ...
                    <TR>
                      <TD>CREATE DATABASE 
database_name</TD></TR></TBODY></TABLE><BR>
                  <HR>
                  ...
                  border=0>
                    <TBODY>
                    <TR>
                      <TD>CREATE DATABASE my_db</TD></TR></TBODY></TABLE>
                  <P>Database tables can be added with the CREATE TABLE 
                  statement.</P>
                  <A 
                  href="http://www.w3schools.com/SQl/sql_select_into.asp"></A> <A 
                  href="http://www.w3schools.com/SQl/sql_create_table.asp"></A> <BR>
                  <!-- **** SPOTLIGHTS 1 **** --></TD>
                                                    </TR>
											  </TBODY></TABLE>
