	  ...
	  <div id="sidebar">							
			...
			<ul class="sidemenu">
				...
				<li><a href="Last.jsp"><font face="Tohama" color="#FFFFFF">SQL Last</font></a></li>
                  ...
                  <P>The LAST() function returns the last value of the selected 
                  column.</P>
                  ...
                  border=0>
                    <TBODY>
                    <TR>
                      <TD>SELECT LAST(column_name) FROM 
                  ...
                  <P>Now we want to find the last value of the "OrderPrice" 
                  column.</P>
                  ...
                  border=0>
                    <TBODY>
                    <TR>
                      <TD>SELECT LAST(OrderPrice) AS LastOrderPrice FROM 
                  ...
                  border=1>
                    <TBODY>
                    <TR>
                      <TH align=left>LastOrderPrice</TH></TR>
                    <TR>
