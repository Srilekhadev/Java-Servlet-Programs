	  ...
	  <div id="sidebar">							
			...
			<ul class="sidemenu">
				...
				<li><a href="Last.jsp"><font face="Tohama" color="#FFFFFF">SQL Last</font></a></li>
                  ...
                  <h2><P class=intro>The AND &amp; OR operators are used to filter 
                  records based on more than one condition.</P></h2>
                  <HR>

                  <H2>The AND &amp; OR Operators</H2>
                  <P>The AND operator displays a record if both the first 
                  condition and the second condition is true.</P>
                  <P>The OR operator displays a record if either the first 
                  condition or the second condition is true.</P>
                  <HR>
                  ...
                  <P>Now we want to select only the persons with the first name 
                  equal to "Tove" AND the last name equal to "Svendson":</P>
                  ...
                  border=0>
                    ...
                    <TR>
                      <TD>SELECT * FROM Persons<BR>WHERE 
                        FirstName='Tove'<BR>AND 
                  LastName='Svendson'</TD></TR></TBODY></TABLE>
                  ...
                  <P>Now we want to select only the persons with the first name 
                  equal to "Tove" OR the first name equal to "Ola":</P>
                  <P>We use the following SELECT statement:</P>
                  <TABLE class=code cellSpacing=0 cellPadding=0 width="100%" 
                  border=0>
                    <TBODY>
                    <TR>
                      <TD>SELECT * FROM Persons<BR>WHERE 
                        FirstName='Tove'<BR>OR 
                  FirstName='Ola'</TD></TR></TBODY></TABLE>
                  <P>The result-set will look like this:</P>
                  <TABLE class=reference cellSpacing=0 cellPadding=0 
                  width="100%" border=1>
                    <TBODY>
                  ...
                  <P>You can also combine AND and OR (use parenthesis to form 
                  complex expressions).</P>
                  <P>Now we want to select only the persons with the last name 
                  ...
                  border=0>
                    <TBODY>
                    <TR>
                      <TD>SELECT * FROM Persons 
                        WHERE<BR>LastName='Svendson'<BR>AND (FirstName='Tove' OR 
                        FirstName='Ola')</TD></TR></TBODY></TABLE>
                  <P>The result-set will look like this:</P>
                  <TABLE class=reference cellSpacing=0 cellPadding=0 
                  width="100%" border=1>
