	  ...
	  <div id="sidebar">							
			...
			<ul class="sidemenu">
				...
				<li><a href="Last.jsp"><font face="Tohama" color="#FFFFFF">SQL Last</font></a></li>
                 ...
                 <h2> <P class=intro>SQL wildcards can be used when searching for 
                  data in a database.</P></h2>
                  <HR>

                  <H2>SQL Wildcards&nbsp;</H2>
                  <P>SQL wildcards can substitute for one or more characters 
                  when searching for data in a database.</P>
                  ...
                  width="100%" border=1>
                    ...
                    <TR>
                      ...
                      <TH vAlign=top align=left width="85%">Description</TH></TR>
                    <TR>
                      <TD vAlign=top>%</TD>
                      <TD vAlign=top>A substitute for zero or more characters 
                      </TD></TR>
                    <TR>
                      <TD vAlign=top>_</TD>
                      <TD vAlign=top>A substitute for exactly one 
                    character</TD></TR>
                    <TR>
                      <TD vAlign=top>[charlist]</TD>
                      <TD vAlign=top>Any single character in charlist</TD></TR>
                    <TR>
                      <TD vAlign=top>[^charlist]
                        <P>or</P>
                        <P>[!charlist]</P></TD>
                      <TD vAlign=top>Any single character not in 
                    charlist</TD></TR></TBODY></TABLE><BR>
                  <HR>
                  ...
                  width="100%" border=1>
                    ...
                    <TR>
                      ...
                      <TD>Kari</TD>
                      <TD>Storgt 20</TD>
                      <TD>Stavanger</TD></TR></TBODY></TABLE><BR>
                  <HR>

                  <H2>Using the % Wildcard</H2>
                  <P>Now we want to select the persons living in a city that 
                  starts with "sa" from the "Persons" table.</P>
                  <P>We use the following SELECT statement:</P>
                  <TABLE class=code cellSpacing=0 cellPadding=0 width="100%" 
                  border=0>
                    <TBODY>
                    <TR>
                      <TD>SELECT * FROM Persons<BR>WHERE City LIKE 
                    'sa%'</TD></TR></TBODY></TABLE>
                  ...
                  width="100%" border=1>
                    ...
                    <TR>
                      ...
                      <TD>Tove</TD>
                      <TD>Borgvn 23</TD>
                      <TD>Sandnes</TD></TR></TBODY></TABLE>
                  <P>Next, we want to select the persons living in a city that 
                  contains the pattern "nes" from the "Persons" table.</P>
                  <P>We use the following SELECT statement:</P>
                  <TABLE class=code cellSpacing=0 cellPadding=0 width="100%" 
                  border=0>
                    <TBODY>
                  ...
                  width="100%" border=1>
                    ...
                    <TR>
                      ...
                      <TD>Tove</TD>
                      <TD>Borgvn 23</TD>
                      <TD>Sandnes</TD></TR></TBODY></TABLE><BR>
                  <HR>

                  <H2>Using the _ Wildcard</H2>
                  <P>Now we want to select the persons with a first name that 
                  ...
                  border=0>
                    <TBODY>
                    <TR>
                      <TD>SELECT * FROM Persons<BR>WHERE FirstName LIKE 
                      '_la'</TD></TR></TBODY></TABLE>
                  <P>The result-set will look like this:</P>
                  <TABLE class=reference cellSpacing=0 cellPadding=0 
                  width="100%" border=1>
                    <TBODY>
                    ...
                    <TR>
                      ...
                      <TD>Timoteivn 10</TD>
                      <TD>Sandnes</TD></TR></TBODY></TABLE>
                  <P>Next, we want to select the persons with a last name that 
                  starts with "S", followed by any character, followed by "end", 
                  followed by any character, followed by "on" from the "Persons" 
                  table.</P>
                  <P>We use the following SELECT statement:</P>
                  <TABLE class=code cellSpacing=0 cellPadding=0 width="100%" 
                  border=0>
                    <TBODY>
                    <TR>
                      <TD>SELECT * FROM Persons<BR>WHERE LastName LIKE 
                        'S_end_on'</TD></TR></TBODY></TABLE>
                  <P>The result-set will look like this:</P>
                  <TABLE class=reference cellSpacing=0 cellPadding=0 
                  width="100%" border=1>
                    <TBODY>
                  ...
                  <P>Now we want to select the persons with a last name that 
                  starts with "b" or "s" or "p" from the "Persons" table.</P>
                  <P>We use the following SELECT statement:</P>
                  <TABLE class=code cellSpacing=0 cellPadding=0 width="100%" 
                  border=0>
                    <TBODY>
                  ...
                  <P>Next, we want to select the persons with a last name that 
                  do not start with "b" or "s" or "p" from the "Persons" 
                  table.</P>
                  <P>We use the following SELECT statement:</P>
                  <TABLE class=code cellSpacing=0 cellPadding=0 width="100%" 
                  border=0>
