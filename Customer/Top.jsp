	  ...
	  <div id="sidebar">							
			...
			<ul class="sidemenu">
				...
				<li><a href="Last.jsp"><font face="Tohama" color="#FFFFFF">SQL Last</font></a></li>
                  ...
                  <P>The TOP clause is used to specify the number of records to 
                  return.</P>
                  <P>The TOP clause can be very useful on large tables with 
                  thousands of records. Returning a large number of records can 
                  impact on performance.</P>
                  <P><B>Note:</B> Not all database systems support the TOP 
                  clause.</P>
                  ...
                  border=0>
                    <TBODY>
                    <TR>
                      <TD>SELECT TOP number|percent column_name(s)<BR>FROM 
                  ...
                  border=0>
                    <TBODY>
                    <TR>
                      <TD>SELECT column_name(s)<BR>FROM table_name<BR>LIMIT 
                  ...
                  border=0>
                    <TBODY>
                    <TR>
                      <TD>SELECT *<BR>FROM Persons<BR>LIMIT 
                  5</TD></TR></TBODY></TABLE>
                  <H3>Oracle Syntax</H3>
                  <TABLE class=code cellSpacing=0 cellPadding=0 width="100%" 
                  border=0>
                    ...
                    <TR>
                      <TD>SELECT column_name(s)<BR>FROM table_name<BR>WHERE 
                        ROWNUM &lt;= number</TD></TR></TBODY></TABLE>
                  <H3>Example</H3>
                  <TABLE class=code cellSpacing=0 cellPadding=0 width="100%" 
                  border=0>
                    <TBODY>
                    <TR>
                      <TD>SELECT *<BR>FROM Persons<BR>WHERE ROWNUM 
                  ...
                  <P>Now we want to select only the two first records in the 
                  table above.</P>
                  ...
                  border=0>
                    <TBODY>
                    <TR>
                      <TD>SELECT TOP 2 * FROM Persons</TD></TR></TBODY></TABLE>
                  ...
                  width="100%" border=1>
                    ...
                    <TR>
                      ...
                      <TD>Vingvn 23</TD>
                      <TD>Stavanger</TD></TR></TBODY></TABLE>
                  <P>Now we want to select only 50% of the records in the table 
                  above.</P>
                  <P>We use the following SELECT statement:</P>
                  <TABLE class=code cellSpacing=0 cellPadding=0 width="100%" 
                  border=0>
