	  ...
	  <div id="sidebar">							
			...
			<ul class="sidemenu">
				...
				<li><a href="Last.jsp"><font face="Tohama" color="#FFFFFF">SQL Last</font></a></li>
                  ...
                  <P>The IN operator allows you to specify multiple values in a 
                  WHERE clause.</P>
                  <H3>SQL IN Syntax</H3>
                  ...
                  border=0>
                    ...
                    <TR>
                      <TD>SELECT column_name(s)<BR>FROM table_name<BR>WHERE 
                        column_name IN 
                  (value1,value2,...)</TD></TR></TBODY></TABLE><BR>
                  <HR>
                  ...
                  <P>Now we want to select the persons with a last name equal to 
                  "Hansen" or "Pettersen" from the table above.</P>
                  <P>We use the following SELECT statement:</P>
                  <TABLE class=code cellSpacing=0 cellPadding=0 width="100%" 
                  border=0>
                    <TBODY>
                    <TR>
                      <TD>SELECT * FROM Persons<BR>WHERE LastName IN 
                        ('Hansen','Pettersen')</TD></TR></TBODY></TABLE>
