	  ...
	  <div id="sidebar">							
			...
			<ul class="sidemenu">
				...
				<li><a href="Last.jsp"><font face="Tohama" color="#FFFFFF">SQL Last</font></a></li>
                  ...
                  <P>The RIGHT JOIN keyword Return all rows from the right table 
                  ...
                  border=0>
                    <TBODY>
                    <TR>
                      <TD>SELECT column_name(s)<BR>FROM table_name1<BR>RIGHT 
                        JOIN table_name2<BR>ON 
                        table_name1.column_name=table_name2.column_name</TD></TR></TBODY></TABLE>
                  <P><B>PS:</B> In some databases RIGHT JOIN is called RIGHT 
                  OUTER JOIN.</P>
                  <HR>
                  ...
                  <P>Now we want to list all the orders with containing persons 
                  - if any, from the tables above.</P>
                  ...
                  border=0>
                    ...
                    <TR>
                      <TD>SELECT Persons.LastName, Persons.FirstName, 
                        Orders.OrderNo<BR>FROM Persons<BR>RIGHT JOIN 
                        Orders<BR>ON Persons.P_Id=Orders.P_Id<BR>ORDER BY 
                  ...
                  <P>The RIGHT JOIN keyword returns all the rows from the right 
                  table (Orders), even if there are no matches in the left table 
                  (Persons).</P>
