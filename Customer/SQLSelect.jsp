	  ...
	  <div id="sidebar">							
			...
			<ul class="sidemenu">
				...
				<li><a href="Last.jsp"><font face="Tohama" color="#FFFFFF">SQL Last</font></a></li>
                  ...
                  <h2>This chapter will explain the SELECT and the 
                  SELECT * statements.</h2>
                  <HR>

                  <H2>The SQL SELECT Statement</H2>
                  <P>The SELECT statement is used to select data from a 
                  database.</P>
                  <P>The result is stored in a result table, called the 
                  result-set.</P>
                  ...
                  border=0>
                    <TBODY>
                    <TR>
                      <TD>SELECT column_name(s)<BR>FROM 
                    table_name</TD></TR></TBODY></TABLE>
                  <P>and</P>
                  <TABLE class=code cellSpacing=0 cellPadding=0 width="100%" 
                  border=0>
                    <TBODY>
                    <TR>
                      <TD>SELECT * FROM table_name</TD></TR></TBODY></TABLE>
                  <P><IMG alt=Note src="images/lamp.gif"> 
                  <B>Note:</B> SQL is not case sensitive. SELECT is the same as 
                  select.</P>
                  <HR>
                  ...
                  <P>Now we want to select the content of the columns named 
                  "LastName" and "FirstName" from the table above.</P>
                  <P>We use the following SELECT statement:</P>
                  <TABLE class=code cellSpacing=0 cellPadding=0 width="100%" 
                  border=0>
                    <TBODY>
                    <TR>
                      <TD>SELECT LastName,FirstName FROM 
                  ...
                  width="100%" border=1>
                    ...
                    <TR>
                      <TD>Pettersen</TD>
                      <TD>Kari</TD></TR></TBODY></TABLE><BR>
                  <HR>

                  <H2>SELECT * Example</H2>
                  <P>Now we want to select all the columns from the "Persons" 
                  table.</P>
                  <P>We use the following SELECT statement:&nbsp;</P>
                  <TABLE class=code cellSpacing=0 cellPadding=0 width="100%" 
                  border=0>
                    <TBODY>
                    <TR>
                      <TD>SELECT * FROM Persons</TD></TR></TBODY></TABLE>
                  <P><B>Tip:</B> The asterisk (*) is a quick way of selecting 
                  all columns!</P>
                  <P>The result-set will look like this:</P>
                  <TABLE class=reference cellSpacing=0 cellPadding=0 
                  width="100%" border=1>
