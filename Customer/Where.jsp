	  ...
	  <div id="sidebar">							
			...
			<ul class="sidemenu">
				...
				<li><a href="Last.jsp"><font face="Tohama" color="#FFFFFF">SQL Last</font></a></li>
                                              ...
                                              <TD class=middle-table-padding vAlign=top align=left><TABLE  align="center" cellSpacing=0 cellPadding=0 width="100%" border=1 bgcolor="#FFFFFF" >
                                                  <TBODY>
                                                    <TR>
													  ...
													  <h2><P class=intro>The WHERE clause is used to filter records.</P></h2>
                  <HR>

                  <H2>The WHERE Clause&nbsp;</H2>
                  <P>The WHERE clause is used to extract only those records that 
                  fulfill a specified criterion.</P>
                  ...
                  border=0>
                    ...
                    <TR>
                      <TD>SELECT column_name(s)<BR>FROM table_name<BR>WHERE 
                        column_name operator value</TD></TR></TBODY></TABLE><BR>
                  <HR>
                  ...
                  <P>Now we want to select only the persons living in the city 
                  "Sandnes" from the table above.</P>
                  <P>We use the following SELECT statement:</P>
                  <TABLE class=code cellSpacing=0 cellPadding=0 width="100%" 
                  border=0>
                    <TBODY>
                    <TR>
                      <TD>SELECT * FROM Persons<BR>WHERE 
                    City='Sandnes'</TD></TR></TBODY></TABLE>
                  ...
                  <P>SQL uses single quotes around text values (most database 
                  systems will also accept double quotes).</P>
                  <P>Although, numeric values should not be enclosed in 
                  quotes.</P>
                  <P>For text values:</P>
                  <TABLE class=code cellSpacing=0 cellPadding=0 width="100%" 
                  border=0>
                    <TBODY>
                    <TR>
                      <TD>This is correct:<BR><BR>SELECT * FROM Persons WHERE 
                        FirstName='Tove'<BR><BR>This is wrong:<BR><BR>SELECT * 
                        FROM Persons WHERE FirstName=Tove</TD></TR></TBODY></TABLE>
                  ...
                  border=0>
                    ...
                    <TR>
                      <TD>This is correct:<BR><BR>SELECT * FROM Persons WHERE 
                        Year=1965<BR><BR>This is wrong:<BR><BR>SELECT * FROM 
                        Persons WHERE Year='1965'</TD></TR></TBODY></TABLE><BR>
