	  ...
	  <div id="sidebar">							
			...
			<ul class="sidemenu">
				...
				<li><a href="Last.jsp"><font face="Tohama" color="#FFFFFF">SQL Last</font></a></li>
                  ...
                  <P>The MIN() function returns the smallest value of the 
                  selected column.</P>
                  ...
                  border=0>
                    <TBODY>
                    <TR>
                      <TD>SELECT MIN(column_name) FROM 
                  ...
                  <P>Now we want to find the smallest value of the "OrderPrice" 
                  column.</P>
                  ...
                  border=0>
                    <TBODY>
                    <TR>
                      <TD>SELECT MIN(OrderPrice) AS SmallestOrderPrice FROM 
                  ...
                  border=1>
                    <TBODY>
                    <TR>
                      <TH align=left>SmallestOrderPrice</TH></TR>
                    <TR>
