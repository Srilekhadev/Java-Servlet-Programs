                                    ...
                                    <tr>
                                      <td align="center"><table width="100%" border="0" cellpadding="0" cellspacing="0" background="images/bg-top-nav.jpg">
                                        <tr>
                                          ...
                                          <td align="center" class="navigation_text"><a href="index.jsp">Home page</a></td>
                                          <td width="10"><img src="images/joint-top-nav.jpg" width="10" height="35"></td>
                                          <td align="center" class="navigation_text"><a href="aboutus.htm">About us</a></td>
                                          <td width="10"><img src="images/joint-top-nav.jpg" width="10" height="35"></td>
                                          <td align="center" class="navigation_text"><a href="forum.htm"></a></td>
                                          <td width="10"><img src="images/joint-top-nav.jpg" width="10" height="35"></td>
                                          <td align="center" class="navigation_text"><a href="reference.htm"></a></td>
                                          <td width="10"><img src="images/joint-top-nav.jpg" width="10" height="35"></td>
                                          <td align="center" class="navigation_text"><a href="contact.htm">Contacts</a></td>
                                          <td width="10"><img src="images/joint-top-nav.jpg" width="10" height="35"></td>
                                          <td align="center" class="navigation_text"><a href="login.htm">Login</a></td>
	  ...
	  <div id="sidebar">							
			...
			<ul class="sidemenu">
				...
				<li><a href="Last.jsp"><font face="Tohama" color="#FFFFFF">SQL Last</font></a></li>
                  ...
                  <P>The MAX() function returns the largest value of the 
                  selected column.</P>
                  ...
                  border=0>
                    <TBODY>
                    <TR>
                      <TD>SELECT MAX(column_name) FROM 
                  ...
                  width="100%" border=1>
                    ...
                    <TR>
                      ...
                      <TD>2008/10/04</TD>
                      <TD>100</TD>
                      <TD>Nilsen</TD></TR></TBODY></TABLE>
                  <P>Now we want to find the largest value of the "OrderPrice" 
                  column.</P>
                  ...
                  border=0>
                    <TBODY>
                    <TR>
                      <TD>SELECT MAX(OrderPrice) AS LargestOrderPrice FROM 
                  ...
                  border=1>
                    <TBODY>
                    <TR>
                      <TH align=left>LargestOrderPrice</TH></TR>
                    <TR>
                      <TD>2000</TD></TR></TBODY></TABLE><BR>
