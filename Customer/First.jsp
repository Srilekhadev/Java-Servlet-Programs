	  ...
	  <div id="sidebar">							
			...
			<ul class="sidemenu">
				...
				<li><a href="Last.jsp"><font face="Tohama" color="#FFFFFF">SQL Last</font></a></li>
                  ...
                  <P>The FIRST() function returns the first value of the 
                  selected column.</P>
                  ...
                  border=0>
                    <TBODY>
                    <TR>
                      <TD>SELECT FIRST(column_name) FROM 
                  ...
                  <P>Now we want to find the first value of the "OrderPrice" 
                  column.</P>
                  ...
                  border=0>
                    <TBODY>
                    <TR>
                      <TD>SELECT FIRST(OrderPrice) AS FirstOrderPrice FROM 
                  ...
                  border=1>
                    <TBODY>
                    <TR>
                      <TH align=left>FirstOrderPrice</TH></TR>
                    <TR>
                      <TD>1000</TD></TR></TBODY></TABLE><BR>
