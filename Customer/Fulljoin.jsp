			...
			<ul class="sidemenu">
				...
				<li><a href="Last.jsp"><font face="Tohama" color="#FFFFFF">SQL Last</font></a></li>
										  ...
										  <tr><td height="30px"></td></tr>
                                            <TR>
                                              <TD class=middle-table-padding vAlign=top align=left><TABLE  align="center" cellSpacing=0 cellPadding=0 width="100%" border=1 bgcolor="#FFFFFF" >
                                                  <TBODY>
                                                    <TR>
                                                      <TD height="109" vAlign=top class=padding-lr >  
													  <p>&nbsp;</p>

                  <H2>SQL FULL JOIN Keyword</H2>
                  <P>The FULL JOIN keyword return rows when there is a match in 
                  one of the tables.</P>
                  ...
                  border=0>
                    <TBODY>
                    <TR>
                      <TD>SELECT column_name(s)<BR>FROM table_name1<BR>FULL 
                        JOIN table_name2<BR>ON 
                        table_name1.column_name=table_name2.column_name</TD></TR></TBODY></TABLE><BR>
                  <HR>
                  ...
                  <P>Now we want to list all the persons and their orders, and 
                  all the orders with their persons.</P>
                  <P>We use the following SELECT statement:</P>
                  <TABLE class=code cellSpacing=0 cellPadding=0 width="100%" 
                  border=0>
                    <TBODY>
                    <TR>
                      <TD>SELECT Persons.LastName, Persons.FirstName, 
                        Orders.OrderNo<BR>FROM Persons<BR>FULL JOIN Orders<BR>ON 
                        Persons.P_Id=Orders.P_Id<BR>ORDER BY 
                    Persons.LastName</TD></TR></TBODY></TABLE>
                  ...
                  width="100%" border=1>
                    ...
                    <TR>
                      <TD>&nbsp;</TD>
                      <TD>&nbsp;</TD>
                      <TD>34764</TD></TR></TBODY></TABLE>
                  <P>The FULL JOIN keyword returns all the rows from the left 
                  table (Persons), and all the rows from the right table 
                  (Orders). If there are rows in "Persons" that do not have 
                  matches in "Orders", or if there are rows in "Orders" that do 
                  not have matches in "Persons", those rows will be listed as 
                  well.</P>
