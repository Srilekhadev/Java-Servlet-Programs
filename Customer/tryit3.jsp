...
<script>
	function file1()
	{
		 alert();
		 var str=document.getElementById("submit").value;	
		document.form1.action = "R1?formname=form7";
		document.form1.submit();
	}
...
<script>
	...
	{
		 alert();
		 document.form2.action = "R1?formname=form8";
		 document.form2.submit();
	}
...
<script>
	...
	{
		 alert();
		 document.form3.action = "R1?formname=form9";
		 document.form3.submit();
	}
...
<script>
	...
	{
		 alert();
		 document.form4.action = "R1?formname=form10";
                                            ...
                                            <tbody>
                                              <tr>
                                                ...
                                                Try it Yourself</h2>
                                                   ...
                                                   <table>
                                                        <tr>
                                                          <td align="left"><p class="gray_bold_text">Select All details from the Customerdetails table</p>
