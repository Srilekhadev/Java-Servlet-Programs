	  ...
	  <div id="sidebar">							
			...
			<ul class="sidemenu">
				...
				<li><a href="Last.jsp"><font face="Tohama" color="#FFFFFF">SQL Last</font></a></li>
                  ...
                  <P>The CREATE TABLE statement is used to create a table in a 
                  database.</P>
                  ...
                  border=0>
                    <TBODY>
                    <TR>
                      <TD>CREATE TABLE table_name<BR>(<BR>column_name1 
                        data_type,<BR>column_name2 data_type,<BR>column_name3 
                        data_type,<BR>....<BR>)</TD></TR></TBODY></TABLE>
                  <P>The data type specifies what type of data the column can 
                  hold. For a complete reference of all the data types available 
                  in MS Access, MySQL, and SQL Server, go to our complete <A 
                  href="http://www.w3schools.com/SQl/sql_datatypes.asp">Data 
                  Types reference</A>.</P>
                  <HR>

                  <H2>CREATE TABLE Example</H2>
                  <P>Now we want to create a table called "Persons" that 
                  contains five columns: P_Id, LastName, FirstName, Address, and 
                  City.</P>
                  ...
                  border=0>
                    <TBODY>
                    <TR>
                      <TD>CREATE TABLE Persons<BR>(<BR>P_Id int,<BR>LastName 
                        varchar(255),<BR>FirstName varchar(255),<BR>Address 
                        varchar(255),<BR>City 
                  varchar(255)<BR>)</TD></TR></TBODY></TABLE>
                  <P>The P_Id column is of type int and will hold a number. The 
                  LastName, FirstName, Address, and City columns are of type 
                  varchar with a maximum length of 255 characters.</P>
                  ...
                  <P>The empty table can be filled with data with the INSERT 
                  INTO statement.</P>
